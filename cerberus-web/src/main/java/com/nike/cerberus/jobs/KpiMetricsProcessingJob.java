...
public class KpiMetricsProcessingJob {
    ...
    public void processKpiMetrics() {
        ...
        metricsService.getOrCreateCallbackGauge("numberOfUniqueIamRoles", () -> numUniqueIamRoles, dimensions);;
        metricsService.getOrCreateCallbackGauge("numberOfUniqueOwnerGroups", () -> numUniqueOwnerGroups, dimensions);;
        metricsService.getOrCreateCallbackGauge("numberOfUniqueNonOwnerGroups", () -> numUniqueNonOwnerGroups, dimensions);;
        metricsService.getOrCreateCallbackGauge("totalUniqueUserGroups", () -> totalUniqueUserGroups, dimensions);;
        ...
        metricsService.getOrCreateCallbackGauge("numberOfKeyValuePairs", () -> numKeyValuePairs, dimensions);;
