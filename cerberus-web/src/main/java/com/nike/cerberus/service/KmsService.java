...
public class KmsService {
    ...
    @Autowired
    public KmsService(AwsIamRoleDao awsIamRoleDao,
    ...
    @Transactional
    protected AwsIamRoleKmsKeyRecord createKmsKeyRecord(final String iamRoleRecordId,
    ...
    protected Optional<Policy> downloadPolicy(String kmsCmkId, String regionName, int retryCount) {
        ...
        try {
            var policy = kmsPolicyService.getPolicyFromPolicyString(getKmsKeyPolicy(kmsCmkId, regionName));
