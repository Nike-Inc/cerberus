...
public class TokenHasher {
    ...
    public static final String HASH_ITERATIONS_CONFIG_PARAM = "${cerberus.auth.token.hash.iterations}";
     ...
     */
    @Autowired
    public TokenHasher(@Value(HASH_SALT_CONFIG_PARAM) final String hashSalt,
