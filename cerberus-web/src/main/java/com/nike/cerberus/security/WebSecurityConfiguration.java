...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
  ...
  RequestMatcher getDoesRequestsRequireAuthMatcher() {
    ...
    List<RequestMatcher> whiteListMatchers = AUTHENTICATION_NOT_REQUIRED_WHITELIST.stream()
  ...
  protected void configure(HttpSecurity http) throws Exception {
    ...
    var dbTokenFilter = new DatabaseTokenAuthenticationProcessingFilter(requestDoesNotRequireAuthMatcher, authTokenService, springApiExceptionHandler);
    ...
    http
      .authorizeRequests()
      .antMatchers(AUTHENTICATION_NOT_REQUIRED_WHITELIST.toArray(new String[0])).permitAll()
    .and()
      .authorizeRequests()
