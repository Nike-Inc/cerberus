...
public class AwsIamKmsAuthV1Controller {
  ...
  @Autowired
  public AwsIamKmsAuthV1Controller(AuthenticationService authenticationService,
  ...
  public EncryptedAuthDataWrapper authenticate(@RequestBody IamRoleCredentials request) {
    ...
    try {
      ...
      eventProcessorService.ingestEvent(createBaseAuditableEvent(iamPrincipalArn)
