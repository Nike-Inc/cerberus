...
public class CerberusSigningKeyResolverTest {
  @Mock
  private CerberusSigningKeyResolver.JwtServiceOptionalPropertyHolder
  ...
  public void test_get_future_jwt_secrets() {
    List<JwtSecret> futureJwtSecrets =
        cerberusSigningKeyResolver.getFutureJwtSecrets(jwtSecretData, 300);
  ...
  public void test_refresh_with_weak_key_should_throw_exception() {
    LinkedList<JwtSecret> jwtSecrets =
        cerberusSigningKeyResolver.getJwtSecretData().getJwtSecrets();
  ...
  public void test_refresh_with_empty_kid_should_throw_exception() {
    ...
    jwtSecret.setId("");
    jwtSecret.setSecret(
        "DAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA==");
    jwtSecrets.add(jwtSecret);
