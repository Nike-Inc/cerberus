...
public class AuthenticationServiceTest {
  ...
  @Mock private AuthConnector authConnector;
  ...
  @Mock private AwsIamRoleService awsIamRoleService;
  ...
  public void setup() {
    initMocks(this);
    objectMapper = ApplicationConfiguration.getObjectMapper();
  ...
  public void tests_that_generateCommonVaultPrincipalAuthMetadata_contains_expected_fields() {
    ...
    Map<String, String> result =
        authenticationService.generateCommonIamPrincipalAuthMetadata(principalArn, region);
  ...
  @Test
  public void
      tests_that_generateCommonIamPrincipalAuthMetadata_checks_base_iam_role_arn_of_assumed_role_arn() {
    ...
    Map<String, String> result =
        authenticationService.generateCommonIamPrincipalAuthMetadata(principalArn);
  ...
  public void tests_that_generateCommonIamPrincipalAuthMetadata_checks_role_arn() {
    ...
    Map<String, String> result =
        authenticationService.generateCommonIamPrincipalAuthMetadata(iamRoleArn);
  ...
  public void test_that_getKeyId_only_validates_kms_policy_one_time_within_interval() {
    ...
    when(awsIamRoleDao.getKmsKey(iamRoleId, region))
        .thenReturn(Optional.of(awsIamRoleKmsKeyRecord));

    when(dateTimeSupplier.get()).thenReturn(now);

    String result =
        authenticationService
            .getKmsKeyRecordForIamPrincipal(awsIamRoleRecord, region)
            .getAwsKmsKeyId();
  ...
  @Test
  public void
      test_that_findIamRoleAssociatedWithSdb_returns_first_matching_iam_role_record_if_found() {
  ...
  @Test
  public void
      test_that_findIamRoleAssociatedWithSdb_returns_generic_role_when_iam_principal_not_found() {
  ...
  @Test
  public void
      test_that_findIamRoleAssociatedWithSdb_returns_generic_role_when_iam_principal_not_found_and_root_found() {
  ...
  @Test
  public void
      tests_that_validateAuthPayloadSizeAndTruncateIfLargerThanMaxKmsSupportedSize_returns_a_truncated_payload_if_the_size_cannot_be_encrypted_by_kms()
          throws JsonProcessingException {
  ...
  @Test
  public void
      tests_that_refreshUserToken_throws_access_denied_when_an_iam_principal_tries_to_call_it() {
    ...
    assertEquals(
        ...
        Integer.parseInt(
            response
                ...
                .getClientToken()
                .getMetadata()
                .get(CerberusPrincipal.METADATA_KEY_TOKEN_REFRESH_COUNT)));
  }

  @Test
  public void
      tests_that_refreshUserToken_throws_access_denied_token_when_count_is_eq_or_greater_than_limit() {
    CerberusPrincipal principal = mock(CerberusPrincipal.class);
