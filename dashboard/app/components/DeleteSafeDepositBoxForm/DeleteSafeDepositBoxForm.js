            ...
            <div className="delete-sdb-wrapper">
                <form id="delete-safe-deposit-box" onSubmit={handleSubmit( () => {
                    ...
                    <div id="form-description" className="ncss-brand">
                        <h3><span className="attention">ATTENTION:</span>Deleting a Safe Deposit Box is irreversible and will delete all data associated with this SDB including past versions of secure data.</h3>
                    </div>
