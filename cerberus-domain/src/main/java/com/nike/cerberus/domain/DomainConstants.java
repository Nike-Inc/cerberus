...
public class DomainConstants {
   ...
   * policies.
   */
  public static final Pattern IAM_PRINCIPAL_ARN_PATTERN_ROLE_GENERATION = Pattern.compile(AWS_IAM_PRINCIPAL_ARN_REGEX_ROLE_GENERATION);
  public static final String AWS_ACCOUNT_ROOT_ARN_REGEX = "^arn:aws:iam::(?<accountId>\\d+?):root$";
  public static final Pattern AWS_ACCOUNT_ROOT_ARN_PATTERN = Pattern.compile(AWS_ACCOUNT_ROOT_ARN_REGEX);
  ...
  public static final Pattern IAM_ASSUMED_ROLE_ARN_PATTERN = Pattern.compile(AWS_IAM_ASSUMED_ROLE_ARN_REGEX);
  private static final String GENERIC_ASSUMED_ROLE_REGEX = "^arn:aws:sts::(?<accountId>\\d+?):assumed-role/.+$";
  public static final Pattern GENERIC_ASSUMED_ROLE_PATTERN = Pattern.compile(GENERIC_ASSUMED_ROLE_REGEX);
