...
public class SecureDataVersionDaoTest {
    ...
    @Mock
    private SecureDataVersionMapper secureDataVersionMapper;
    ...
    public void readSecureDataVersionById_returns_record_when_found() {
        when(secureDataVersionMapper.readSecureDataVersionById(versionId)).thenReturn(secureDataVersionRecord);
