...
public interface SafeDepositBoxMapper {
    ...
    List<SafeDepositBoxRoleRecord> getIamRoleAssociatedSafeDepositBoxRoles(@Param("awsAccountId") final String awsAccountId,
                                                                           @Param("awsIamRoleName") final String awsIamRoleName);
