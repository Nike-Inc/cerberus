...
public class UserGroupPermissionService {
     ...
     */
    @Transactional
    public void grantUserGroupPermissions(final String safeDepositBoxId,
     ...
     */
    @Transactional
    public void grantUserGroupPermission(final String safeDepositBoxId,
     ...
     */
    @Transactional
    public void updateUserGroupPermissions(final String safeDepositBoxId,
                                           final Set<UserGroupPermission> userGroupPermissionSet,
                                           final String user,
                                           final OffsetDateTime dateTime) {
        for (final UserGroupPermission userGroupPermission : userGroupPermissionSet) {
